...
@Injectable()
export class RealtorLeadAdapter implements ProviderLeadAdapter {
  readonly provider = "realtor" as const;
  ...
  normalize(
    ...
    const property = {
      ...nestedRecord(payload, "property", "listing"),
      ...nestedRecord(root, "property", "listing"),
    };
